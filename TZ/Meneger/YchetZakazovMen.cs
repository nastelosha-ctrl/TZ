...
namespace TZ
{
    public partial class YchetZakazovMen : Form
    {
        ...
        {
            // предполагаем, что менеджеры — это пользователи с ролью "Менеджер"
            string sql = @"
        ...
        private void btnViewOrder_Click(object sender, EventArgs e)
        {
            ...
            ProsmotrsoderZakazaMen formView = new ProsmotrsoderZakazaMen(orderId);  // ← подставь реальное имя формы
            formView.ShowDialog();

            // после закрытия можно обновить список
            // LoadOrders();  // если в просмотре могли изменить статус
        }
